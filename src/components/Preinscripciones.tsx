...
import { BookOpen, User, Users, GraduationCap, Calendar, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          <div 
            ...
            style={{ backgroundColor: 'hsl(53, 91%, 61%)', color: 'hsl(228, 72%, 11%)' }}
          >
        ...
        <div className="mb-12 max-w-4xl mx-auto">
          <p 
            ...
            style={{ color: 'hsl(0, 0%, 100%)' }}
          >
            ¿Querés que tus hijos formen parte de una comunidad educativa que enseña con valores, propósito y excelencia académica?
          </p>
          ...
          <p 
            ...
            style={{ color: 'hsl(0, 0%, 100%)' }}
          >
            Ya podés preinscribirte al Ciclo Lectivo 2026 para <span style={{ color: 'hsl(53, 91%, 61%)' }} className="font-semibold">Salas de 4 y 5 años, Nivel Primario</span> y <span style={{ color: 'hsl(53, 91%, 61%)' }} className="font-semibold">Nivel Secundario</span>.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto">
          {educationalLevels.map((level, index) => (
            ...
            >
              ...
              <Button
                className="mt-auto px-6 py-2 text-sm font-medium rounded-lg transition-all duration-300"
                style={{ 
                  backgroundColor: 'hsl(228, 72%, 11%)', 
                  color: 'hsl(0, 0%, 100%)',
                  border: '1px solid hsl(228, 72%, 25%)'
                }}
              >
                Más información
              </Button>
