...
const FamilyResources = () => {
  ...
  const materialesGrades = [
    { grade: '1°', name: 'Lista de Materiales - 1°', downloadUrl: '#' },
    { grade: '2°', name: 'Lista de Materiales - 2°', downloadUrl: '#' },
    { grade: '3°', name: 'Lista de Materiales - 3°', downloadUrl: '#' },
    { grade: '4°', name: 'Lista de Materiales - 4°', downloadUrl: '#' },
    { grade: '5°', name: 'Lista de Materiales - 5°', downloadUrl: '#' },
    { grade: '6°', name: 'Lista de Materiales - 6°', downloadUrl: '#' },
    { grade: '7°', name: 'Lista de Materiales - 7°', downloadUrl: '#' }
  ];
              ...
              {resource.id === 'uniformes' && (
                <Dialog>
                  <DialogTrigger asChild>
                    <div className="bg-white border border-gray-200 rounded-xl p-8 text-center cursor-pointer hover:shadow-lg hover:border-school-yellow/50 transition-all duration-300 transform hover:-translate-y-1 animate-fade-in h-full flex flex-col justify-between"
                    ...
                    <div className="grid gap-4 mt-6">
                      {forms.map((form, idx) => (
                        ...
                        >
                          ...
                          <span className="text-school-blue font-medium">{form.name}</span>
              ...
              {resource.id === 'materiales' && (
                <Dialog>
                  ...
                  <DialogContent className="max-w-3xl">
                    <DialogHeader>
                      <DialogTitle className="text-2xl text-school-blue">Lista de Materiales 2026 - Nivel Inicial</DialogTitle>
                      <DialogDescription>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                      {materialesGrades.map((material, idx) => (
                        ...
                        >
                          ...
                          <span className="text-school-blue font-medium">{material.name}</span>
                          <Download className="text-school-blue ml-auto" size={16} />
                        </Button>
                      ))}
                    </div>
