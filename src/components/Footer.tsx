...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://www.facebook.com/profile.php?id=100063516562917",
      name: "Facebook",
    },
  ]
          ...
          <div>
            ...
            <div className="space-y-3 text-white/80">
              ...
              <div>
                ...
                <p>
                  <span className="font-medium text-white">Nivel Inicial:</span>{" "}
                  +54 03751 426784
                </p>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-white/60 text-sm">
                © 2024 Instituto Bautista del Centro. Todos los derechos
                reservados.
              </p>
            </div>
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm flex items-center justify-center md:justify-end">
                Hecho con <Heart className="text-red-400 mx-1" size={14} /> para
                formar el futuro
              </p>
            </div>
          </div>
