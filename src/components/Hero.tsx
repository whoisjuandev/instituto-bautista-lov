...
const Hero = () => {
  ...
  return <section id="inicio" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 hero-gradient">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-school-blue/80 to-school-blue/60"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          {/* Pre-title */}
          <p className="text-school-yellow font-medium text-lg md:text-xl mb-4 tracking-wide">Bienvenidos al</p>
          ...
          <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto">
            Una educación integral que combina excelencia académica con formación en valores cristianos, 
            preparando a nuestros estudiantes para ser líderes íntegros del mañana.
          </p>
          
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <button onClick={() => document.querySelector('#nosotros')?.scrollIntoView({
            behavior: 'smooth'
        ...
        {/* Scroll indicator */}
        <button onClick={scrollToNextSection} className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white/70 hover:text-school-yellow transition-colors duration-300 animate-bounce">
          <ChevronDown size={32} />
        </button>
      </div>
